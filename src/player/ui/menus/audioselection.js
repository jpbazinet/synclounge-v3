...
export default (store) => {
  class AudioSelection extends shaka.ui.SettingsMenu {
    ...
    constructor(parent, controls) {
      super(parent, controls, audioIcon);
    ...
    updateAudioSelection() {
      ...
      Array.from(this.menu.getElementsByClassName('explicit-audio')).forEach((button) => {
  ...
  shaka.ui.Controls.registerElement('audio', factory);
};
